...
import { isMobile } from '../../../helpers/ui/isMobile'
  ...
  return (
    <div id="Shell" css={shell} className={`fcc`}>
      ...
      {profile.showCalories && (
        <div css={section} className={`fc`}>
          <div css={sectionHeader} className={`fr`}>
            ...
            <div className="ml15">Set calories {`&`} protein</div>
            <button
      ...
      {profile.showCalories && (
        <div css={section} className={`fc`}>
          <div css={sectionHeader} className={`fr`}>
            <Image width={40} height={40} src={Target} alt="Target" />
            <div className="ml15">Target each day</div>
          </div>

          <Explanation color="blue">
            <div className="fr">
              <strong css={explanationHeader}>Calories: </strong>
              Eat {round(profile.calorieTarget * 0.75, 0)} or fewer
            </div>
          </Explanation>

          <Explanation color="green">
            <div className="fr">
              <strong css={explanationHeader}>Protein: </strong> Eat at least{' '}
      ...
      <div css={section} className={`fc`}>
        ...
        <Explanation color="background">
          <div>
            Losing weight is a <strong>skill</strong>, one which is rarely
            taught. Let the Clean Slate curriculum fix that for you!
          </div>
        </Explanation>
      </div>
    </div>
