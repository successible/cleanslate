...
`
type props = {calories: number, protein: number, showTitles: boolean, densities: [number, number, number], profile: Profile }
export const MacroDisplay: React.FC<props> = ({showTitles, calories, protein, densities, profile}) => {
