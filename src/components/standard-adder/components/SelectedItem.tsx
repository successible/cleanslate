...
import { Log, defaultMeal } from '../../../models/log'
...
export const SelectedItem: React.FC<props> = ({
  ...
  useEffect(() => {
    if (
      ...
      const protein = calculatePerMacroPerFood(
        amountAsNumber,
        unit,
        selectedItem,
        'PROTEIN'
      ...
      const protein = calculatePerMacroPerRecipe(
        selectedItem,
        'PROTEIN',
        amountAsNumber,
        unit
    ...
    >
      <div className="fcc">
        ...
        <div className="fr w100 wrap">
          {submitReady && (
            <Explanation color="green" className="mt0 frc" css={{ height: 50 }}>
              <div>
                {
                  <MacroDisplay
                    calories={calories || 0}
                    protein={protein || 0}
                    densities={densities || [0, 0, 0]}
                    profile={profile}
                    showTitles={true}
                  />
                }
