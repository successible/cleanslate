var CreateKoder = (() => {
  ...
  return function (CreateKoder) {
    ...
    var ha = d.print || console.log.bind(console),
      H = d.printErr || console.warn.bind(console)
    aa(d, ca)
    ca = null
    ...
    function Ma(a, b, e, f) {
      ...
      function t(c) {
        ...
        var k = new Date(c.getFullYear() + 1, 0, 4),
          q = r(new Date(c.getFullYear(), 0, 4))
        k = r(k)
        return 0 >= m(q, c)
          ? 0 >= m(k, c)
            ? c.getFullYear() + 1
      ...
      l = {
        ...
        '%U': function (c) {
          var k = new Date(c.A + 1900, 0, 1),
            q = 0 === k.getDay() ? k : Y(k, 7 - k.getDay())
        ...
        '%V': function (c) {
          var k = new Date(c.A + 1901, 0, 4),
            q = r(new Date(c.A + 1900, 0, 4))
          k = r(k)
      ...
      k: function (a, b, e, f) {
        J(
          'Assertion failed: ' +
            P(a) +
            ', at: ' +
            [b ? P(b) : 'unknown filename', e, f ? P(f) : 'unknown function']
        )
      },
    }
    ;(function () {
      ...
      (function () {
        return I ||
          ...
          ? e(b)
          : fetch(T, { credentials: 'same-origin' }).then(function (h) {
